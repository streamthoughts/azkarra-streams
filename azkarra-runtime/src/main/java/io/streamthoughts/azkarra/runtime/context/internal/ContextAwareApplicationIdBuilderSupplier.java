...
public class ContextAwareApplicationIdBuilderSupplier
        extends ContextAwareGettableComponentSupplier<ApplicationIdBuilder> {

    public ContextAwareApplicationIdBuilderSupplier(final AzkarraContext context,
                                                    final GettableComponent<ApplicationIdBuilder> gettable) {
     ...
     */
    @Override
    public ApplicationIdBuilder get() {
        ...
        return new DelegateApplicationIdBuilder(super.get());
    }
    ...
    public static class DelegateApplicationIdBuilder
        ...
        public ApplicationId buildApplicationId(final TopologyMetadata metadata,
            ...
            return delegate.buildApplicationId(metadata, streamsConfig);
        }
    }
}
