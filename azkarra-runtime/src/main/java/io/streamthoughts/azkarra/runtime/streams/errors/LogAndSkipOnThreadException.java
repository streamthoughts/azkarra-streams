 ...
 */
public class LogAndSkipOnThreadException implements StreamThreadExceptionHandler {

    private static final Logger LOG = LoggerFactory.getLogger(LogAndSkipOnThreadException.class);
    ...
    public void handle(final KafkaStreamsContainer container,
        ...
        LOG.error(
            ...
            "A stream thread died due to uncaught exception. Ignore and continue.",
