...
public class EnvironmentConfigTest {
    ...
    public void shouldCreateEnvConfigGivenValidConf() {
        ...
        Assertions.assertNotNull(environmentConfig.config());
        Assertions.assertNotNull(environmentConfig.topologyStreamConfigs());
        Assertions.assertEquals("__default", environmentConfig.name());
    }
}