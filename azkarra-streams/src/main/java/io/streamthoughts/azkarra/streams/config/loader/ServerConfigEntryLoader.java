...
public class ServerConfigEntryLoader extends AbstractConfigEntryLoader {

    private static final String CONFIG_ENTRY_KEY = "server";

    /**
     * Creates a new {@link AbstractConfigEntryLoader} instance.
     */
    public ServerConfigEntryLoader() {
    ...
    public void load(final ConfEntry configEntryObject,
        ...
        final Conf serverConf = configEntryObject.asSubConf();
        application.setHttpServerEnable(serverConf.getOptionalBoolean("enable").orElse(true));
        application.setHttpServerConf(serverConf);
    }
}
