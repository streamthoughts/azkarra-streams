...
public class AutoStartConfigEntryLoader extends AbstractConfigEntryLoader {
    ...
    public void load(final ConfEntry configEntryObject,
        ...
        final Conf autoStart = configEntryObject.asSubConf();
        application.setAutoStart(
            autoStart.getBoolean("enable"),
            autoStart.getOptionalString("environments").orElse(null)
        );
    }
}
