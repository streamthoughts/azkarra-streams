...
public class StreamsConfigEntryLoader extends AbstractConfigEntryLoader {

    public static final String CONFIG_ENTRY_KEY = "streams";

    /**
     * Creates a new {@link StreamsConfigEntryLoader} instance.
     */
    public StreamsConfigEntryLoader() {
    ...
    public void load(final ConfEntry configEntryObject,
        ...
        // Injects "streams." prefixed properties into Azkarra Context.
