...
public class EnvironmentGetListHandler extends AbstractStreamHttpHandler {

    /**
     * Creates a new {@link EnvironmentGetListHandler} instance.
     *
     * @param service   the {@link AzkarraStreamsService} instance.
     */
    public EnvironmentGetListHandler(final AzkarraStreamsService service) {
        super(service);
    }
    ...
    public void handleRequest(final HttpServerExchange exchange) {
        final Set<Environment> environments = service.getAllEnvironments();
