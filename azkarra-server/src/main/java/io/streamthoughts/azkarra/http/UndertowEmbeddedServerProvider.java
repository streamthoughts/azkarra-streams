...
/**
 * Provides an {@link UndertowEmbeddedServer} instance.
 */
public class UndertowEmbeddedServerProvider implements EmbeddedHttpServerProvider {
     ...
     */
    @Override
    public EmbeddedHttpServer get(final AzkarraContext context) {
        return new UndertowEmbeddedServer(context, true);
    }
}
