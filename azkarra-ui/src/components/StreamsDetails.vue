...
*/
<template>
  <div id="component-streams-details-container">
    <div class="main-content-header">
      <ul class="list-inline" v-if="streams.state">
        <li class="list-inline-item">
          <h1 class="main-title">Kafka Streams Instance</h1>
        </li>
        <li class="list-inline-item">
      ...
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <a class="nav-item nav-link"
             ...
             aria-selected="false">
            <span class="nav-link-text">DAG</span>
          </a>
          <a class="nav-item nav-link"
             ...
             aria-selected="false">
            <span class="nav-link-text">Threads/Tasks</span>
          </a>
          <a class="nav-item nav-link"
          ...
          <template v-if="streams.exception">
            <a class="nav-item nav-link"
               ...
               aria-selected="false">
              <span class="nav-link-text">Error Trace</span>
            </a>
          </template>
        </div>
      </nav>
      ...
      <div class="row">
        <div class="col">
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-streams-metrics" role="tabpanel"
                 aria-labelledby="nav-streams-metrics-tab">
              <streams-metrics v-bind:id="id"></streams-metrics>
            </div>
            <div class="tab-pane fade" id="nav-streams-offsets" role="tabpanel"
          ...
          <form>
            <div class="form-check" v-if="isStopAction()">
              <div class="alert alert-warning" role="alert">
                ...
                StateStore directory (StreamsConfig.STATE_DIR_CONFIG) by deleting all data with regard to the
                application
                ID.
              </div>
