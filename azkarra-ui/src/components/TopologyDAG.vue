      ...
      <div class="panel-body">
        <div class="property-card-container">
          <div class="property-card">
            <div class="property-card-name">Sub-Topologies</div>
            <div class="property-card-value">{{ subTopologyCount }}</div>
          </div>
          <div class="property-card">
            <div class="property-card-name">Topic Sources</div>
            <div class="property-card-value">{{ sourceCount }}</div>
          </div>
          <div class="property-card">
            <div class="property-card-name">Topic Sinks</div>
            <div class="property-card-value">{{ sinkCount }}</div>
          </div>
          <div class="property-card">
            <div class="property-card-name">Stores</div>
            <div class="property-card-value">{{ storeCount }}</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    createSVG(objectTopology) {
      ...
      let nodesKeyedByName = objectTopology.nodes();
      ...
      let gSubTopology = gSubTopologies.append("g")
          .attr("id", function (d) {
      ...
      gSubTopology.each(function (subTopology) {
        ...
        let gSubTopologyLevels = d3.select(this).selectAll(".g-sub-topology-level")
            ...
            .attr("id", function (d, i) {
              return "g-sub-topology-" + subTopology.id + "-level-" + i
            })
            .each(function (d, i) {
        ...
        gSubTopologyLevels.selectAll(".g-sub-topology-nodes")
            ...
            .attr("class", function (d) {
              return "g-sub-topology-node g-sub-topology-node-" + d.type.toLowerCase()
            });
      ...
      g.selectAll()
          ...
          .attr("d", d3.linkVertical().x(function (d) {
            return d.x;
          }).y(function (d) {
            return d.y;
          }))
