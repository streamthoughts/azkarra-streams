 ...
 * {@code processing.guarantee} to {@code at_least_once}.
 *
 * @see StreamsConfig#PROCESSING_GUARANTEE_CONFIG
 * @see StreamsConfig#AT_LEAST_ONCE
 */
@Documented
@Inherited
@Target({ElementType.TYPE, ElementType.METHOD})
@Retention(RetentionPolicy.RUNTIME)
@ConfValue(key = "streams." + StreamsConfig.PROCESSING_GUARANTEE_CONFIG, value = StreamsConfig.AT_LEAST_ONCE)
