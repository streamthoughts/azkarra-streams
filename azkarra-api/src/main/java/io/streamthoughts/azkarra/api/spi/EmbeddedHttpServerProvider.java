...
/**
 * Default Service Provider interface to provides an {@link EmbeddedHttpServer} implementation.
 */
public interface EmbeddedHttpServerProvider {
     ...
     * @return  a new {@link EmbeddedHttpServer} interface.
     */
    EmbeddedHttpServer get(final AzkarraContext context);
}
