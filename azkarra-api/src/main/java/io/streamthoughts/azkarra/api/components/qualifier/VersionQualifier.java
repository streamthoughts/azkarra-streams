...
public class VersionQualifier<T> implements Qualifier<T> {
    ...
    /**
     * Creates a new {@link VersionQualifier} instance.
     *
     * @param version   the {@link Version}.
     */
    VersionQualifier(final Version version) {
    ...
    public Stream<ComponentDescriptor<T>> filter(final Class<T> componentType,
        ...
        return candidates
            ...
            .filter(desc -> desc.version().equals(version));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VersionQualifier)) return false;
