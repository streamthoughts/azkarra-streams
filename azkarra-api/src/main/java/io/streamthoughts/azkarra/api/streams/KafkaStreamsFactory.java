...
public interface KafkaStreamsFactory {
    ...
    /**
     * Creates a new {@link KafkaStreams} instance for the specified container.
     *
     * @param container the {@link KafkaStreamsContainer} instance.
     * @return  a new {@link KafkaStreams} instance.
     */
    KafkaStreams make(final KafkaStreamsContainer container);
}
