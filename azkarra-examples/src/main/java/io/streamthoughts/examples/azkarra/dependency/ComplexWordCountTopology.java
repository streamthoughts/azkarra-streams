...
public class ComplexWordCountTopology implements TopologyProvider, Configurable {
    ...
    private StopWordsService stopWords;

    private String topicSource;
    private String topicSink;
    private String storeName;

    // Note that a {@link TopologyProvider} must always define a public no-arg constructor.
    public ComplexWordCountTopology() {

    }

    public void setStopWordsService(final StopWordsService stopWords) {
